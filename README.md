...
## 🔴 Live Status
<!-- LIVE_URLS_START -->
> **Current Run (Tailscale, tailnet only):** [Desktop](https://100.118.243.94:8443) `https://100.118.243.94:8443` | [MCP](http://100.118.243.94:8000) `http://100.118.243.94:8000` /mcp
> *Last updated: 2026-09-06 17:32 UTC — [Run #101](https://github.com/observer-spec/RDP-AI/actions/runs/34048829739) — auto-updated by workflow*
> Desktop login: `runner` / `VNC_PASSWORD` (accept self-signed cert) — MCP: `Authorization: Bearer $MCP_TOKEN` at `/mcp`
> RDP (Windows Remote Desktop): `100.118.243.94:3389` — same login
<!-- LIVE_URLS_END -->
